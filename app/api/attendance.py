...
from app.models import User, Technician, TechnicianAttendance
...
def attendance_to_response(attendance: TechnicianAttendance, include_technician: bool = False) -> dict:
