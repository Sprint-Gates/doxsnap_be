...
"""
        ...
        html += f"""
    <div class="footer">
        <p>This mock email was generated by DoxSnap invoice processing system.</p>
        <p>For support, please contact: noreply@arabiaesim.com</p>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>This is a mock email from DoxSnap for development/testing purposes.</p>
